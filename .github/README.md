...
[`@aws-sdk/client-apigatewayv2`](https://www.npmjs.com/package/@aws-sdk/client-apigatewayv2/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-apigatewayv2@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Nd9NdsTCaMBM3UVVXur5QJoCp5lU9+t+boZxpd9LIzJPapLYmTUarUbF0YJfTeBJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-apigatewayv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-apigatewayv2@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-apigatewayv2@3.290.0/index.min.mjs": "sha384-Nd9NdsTCaMBM3UVVXur5QJoCp5lU9+t+boZxpd9LIzJPapLYmTUarUbF0YJfTeBJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-apigatewayv2/blob/refs/tags/3.290.0/LICENSE
```
